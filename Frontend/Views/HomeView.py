                    ...
                    content=ft.Row(
                        [
                            ft.Image(
                                ...
                                width=40 * page.width * 4 / 1500,
                                height=40 * page.width * 4 / 1500,
                                fit=ft.ImageFit.CONTAIN,
                            ),
                            ft.Image(
                                src=f"Icons/Settings.png",
                                width=27 * page.width * 4 / 1500,
                                height=27 * page.width * 4 / 1500,
                                fit=ft.ImageFit.CONTAIN,
                            ),
                        ],
                        ...
                        ft.Row(
                            [
                                ft.Container(
                                    content=ft.Column(
                                        [
                                            ...
                                            ft.ProgressRing(
                                                ...
                                                width=page.width * 4 * 0.113 * 0.5,
                                                height=page.width * 4 * 0.113 * 0.5,
                                                stroke_align=0,
                                            ),
                                        ],
                                    ...
                                    width=page.width * 4 * 0.21 * 0.5,
                                    height=page.width * 4 * 0.21 * 0.5,
                                ...
                                ft.Container(
                                    content=ft.Column(
                                        [
                                            ft.Image(
                                                src="Icons/Plus.png",
                                                width=100 * page.width * 4 / 1500,
                                                height=100 * page.width * 4 / 1500,
                                                fit=ft.ImageFit.CONTAIN,
                                            ),
                                        ],
                                        alignment=ft.MainAxisAlignment.CENTER,
