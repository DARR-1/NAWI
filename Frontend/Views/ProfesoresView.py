...
def profesoresView(page, goFunc: callable, ft=ft):
    onHoverContainer = ft.Row(
            ...
            ft.Container(
                content=ft.Column(
                    [
                        ft.Image(
                            src="Icons/Book.png",
                            width=0.03 * page.width,
                            height=0.03 * page.width,
                        ),
                        ft.Text(
                            "Lecciones",
                            font_family="Monserrat Alternates",
                            size=0.007 * page.width,
                ...
                height=0.05 * page.width,
                padding=0,
                ink=True,
                on_click=lambda e: goFunc("/Lecciones"),
            ),
            ft.Container(
                width=0.001 * page.width,
                height=0.1 * page.width,
        ...
        width=0.22 * page.width,
        height=0.085 * page.width,
    )
    defaultContent = ft.Row(
        [
            ft.Image(
                src="Icons/FotoDocentePrueba.png",
                width=0.075 * page.width,
                height=0.05 * page.width,
            ),
            ft.Column(
                [
                    ft.Text(
                        "Nombre del Docente",
                        font_family="Monserrat Alternates",
                        size=0.01 * page.width,
                        color=page.theme.color_scheme.on_background,
                    ),
                    ft.Text(
                        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                        font_family="Monserrat Alternates",
                        size=0.005 * page.width,
                        color=page.theme.color_scheme.on_background,
                        width=0.12 * page.width,
                    ),
                ],
                alignment=ft.MainAxisAlignment.START,
                height=0.07 * page.width,
            ),
        ],
        alignment=ft.MainAxisAlignment.CENTER,
        vertical_alignment=ft.CrossAxisAlignment.CENTER,
                    ...
                    content=ft.Row(
                        [
                            ft.Text(
                                "Tus docentes",
                                font_family="Monserrat Alternates",
                                size=0.02 * page.width,
                                color=page.theme.color_scheme.on_background,
                            ),
                            ft.Container(
                                content=ft.Image(
                                    src="Icons/User plus.png",
                                    width=0.05 * page.width,
                                    height=0.05 * page.width,
                                ),
                            ),
                        ],
